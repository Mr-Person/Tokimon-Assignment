...
class TrainersControllerTest < ActionController::TestCase
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post :create, trainer: { description: @trainer.description, level: @trainer.level, name: @trainer.name }
    end
  ...
  test "should update trainer" do
    patch :update, id: @trainer, trainer: { description: @trainer.description, level: @trainer.level, name: @trainer.name }
    assert_redirected_to trainer_path(assigns(:trainer))
  end
